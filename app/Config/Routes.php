...
// route halaman about
$routes->get('user/about', 'user\Aboutctrl::index');
// route halaman produk
$routes->get('user/produk', 'user\Productsctrl::index');
$routes->get('user/produk/detail/(:num)/(:segment)_(:segment)', 'user\Productsctrl::detail/$1/$2/$3');
// routes halaman aktivitas
$routes->get('user/aktivitas', 'user\Aktivitasctrl::index');
$routes->get('user/aktivitas/detail/(:num)/(:segment)_(:segment)', 'user\Aktivitasctrl::detail/$1/$2/$3');
// routes halaman contact
$routes->get('user/contact', 'user\Contactctrl::index');
